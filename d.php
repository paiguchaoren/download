...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <link href="https://cdn.bootcdn.net/ajax/libs/dropzone/6.0.0-beta.2/dropzone.min.css" rel="stylesheet">
    <div class="path">
    ...
    <script src="https://cdn.bootcdn.net/ajax/libs/dropzone/6.0.0-beta.2/dropzone.min.js"></script>
    <script>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE):
        ...
        ?>
    <script src="https://cdn.bootcdn.net/ajax/libs/ace/1.4.14/ace.js"></script>
    <script>
